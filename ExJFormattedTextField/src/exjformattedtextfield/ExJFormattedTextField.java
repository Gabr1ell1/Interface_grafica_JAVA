...
public class ExJFormattedTextField extends JFrame{
    ...
    MaskFormatter mascaracep, mascaratel, mascaracpf, mascaradata;
        ...
        public ExJFormattedTextField(){
            super("Janela com JFormattedTextField");
            ...
            try{//é usado para envolver um conjunto de instruções que podem gerar exceções. 
                //cria formatações específicas para os campos
            ...
            catch(ParseException excp){}//código para as exceções 
    ...
    public static void main(String[] args) {
        ExJFormattedTextField app = new ExJFormattedTextField();
